...
class SentChatResource extends JsonResource{
    public function toArray($request){
        ...
        return [
            ...
            'other_customer'=>new CustomerBreifResource(Customer::find($current_customer_id)),
            'last_message'=>new ChatMessageResource($this->chatMessages()->orderByDesc('id')->first()),
            'unread_count'=>$this->chatMessages()->whereCustomer2Id($other_customer_id)->unread()->count(),
