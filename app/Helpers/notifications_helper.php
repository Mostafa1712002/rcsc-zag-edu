...
function spark_send_fcm($notifiable, $title = '', $body = '', $notification_content = [],$create_notification=1){
	...
	foreach ($to as $device) {
		spark_send_single_fcm($device, $title, $body, $notification_content);
	}
}

function spark_send_single_fcm($to = '', $title = '', $body = '', $notification_content = []){
