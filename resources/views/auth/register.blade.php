...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{asset('front-assets/vendors/mdi/css/materialdesignicons.min')}}">
    <link rel="stylesheet" href="{{asset('front-assets/vendors/css/vendor.bundle.base')}}">
    <!-- endinject -->
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{asset('front-assets/css/style')}}">
    <!-- End layout styles -->
  ...
  <body>
    ...
    <script src="{{asset('front-assets/js/settings.js')}}"></script>
