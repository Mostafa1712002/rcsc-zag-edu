                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="contact">
                            ...
                            <p>@lang('site.fill_these_to_calculate_commission')</p>
                                ...
                                <p>
                                    @lang('validation.attributes.bank_account_id'): {{$bank_account_id}}
                                </p>
                                ...
                                <h5>@lang('site.upload_commission_form')</h5>
                                <p>@lang('site.upload_commission_form_by_filling_this_form')</p>
                                @livewire('store-commission')
                        </div>
